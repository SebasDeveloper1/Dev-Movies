...
const { titleTexts, descriptionTexts, buttonTexts, inputTexts } =
  ...
  const view = /* html */ `
    <div class="header__container-main header__container-main--favorites">
        ...
        <div class="header-titles">
            <h1 class="header-title--favorites">${titleTexts.titleFavorites}</h1>
            <h4 class="header__description">⭐ ${descriptionTexts.descriptionFavorites} ⭐</h4>
        </div>
